...
class ConfigManager:
    ...
    def set_zotero_version(self, version: str):
        self._config.zotero_version = version
        self.save()
    ...
    def set_auto_create_shortcut(self, value: bool):
        self._config.auto_create_shortcut = value
        self.save()